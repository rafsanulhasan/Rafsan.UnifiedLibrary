...
public partial class EFRepositoryFactory : IRepositoryFactory
{
	...
	/// <inheritdoc />
	public async ValueTask<IRepository<TEntity>> ResolveRepository<TEntity, TContext>(ServiceLifetime lifetime)
		where TEntity : class
	...
	public async ValueTask<IRepository<TEntity>> ResolveRepositoryFromPool<TEntity, TContext>(
